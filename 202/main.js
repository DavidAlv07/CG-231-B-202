 ...
 * SALIDAS: geom = Geometria construda con vx
 */
...
function init() {
    ...
    EscaladoReal(piramide[0], vt, [1.5,1.5,1.5]);// Escalado  150%
    RotacionReal(piramide[0], vt ,45,1);//Rotacion en el eje x 
    RotacionReal(piramide[0], vt ,45,2);//Rotacion en el eje y 
    RotacionReal(piramide[0], vt ,60,3);//Rotacion en el eje z 
